...
export const AMENITIES = [
  ...
  { id: 'kit_earplugs',           name: 'Backpacker Earplugs',     tag: 'backpack', costBase: 4000, comfort: 16, xMult: 0.03, xScope: 'all',    unlockComfort: 300, flavor: 'For the bunkmate who snores in three languages. The motel pair died a hero.' },
  ...
  { id: 'gold_leaf_stroopwafel',   name: 'Gold-Leaf Stroopwafel',     tag: 'luxury', costBase: 7e7,   costGrowth: 1.9, comfort: 3000, exclusivity: 6,  xMult: 0, xScope: 'all', unlockComfort: 6.5e7, flavor: 'A stroopwafel, wrapped in gold leaf. It tastes exactly like a normal stroopwafel. This is the point.' },
  { id: 'royal_pillow_menu',       name: 'The Royal Pillow Menu',      tag: 'luxury', costBase: 1.1e8, costGrowth: 1.9, comfort: 3300, xMult: 0, xScope: 'all', unlockComfort: 8.5e7, flavor: 'Eleven pillows to choose from, by firmness, altitude, and mood. You order the one from bunk 4, out of nostalgia. It is not on the menu. They make it anyway.' },
  { id: 'private_elevator_music',  name: 'Private Elevator Music',    tag: 'luxury', costBase: 1.8e8, costGrowth: 1.9, comfort: 3600, exclusivity: 9,  xMult: 0,xScope: 'all', unlockComfort: 1.1e8, flavor: 'The lift plays a composition written for you. Four floors is not long enough to enjoy it. You ride up and down anyway.' },
  { id: 'monogrammed_bathrobe',    name: 'Monogrammed Bathrobe',      tag: 'luxury', costBase: 3e8,   costGrowth: 1.9, comfort: 3900, exclusivity: 11, xMult: 0,xScope: 'all', unlockComfort: 1.4e8, flavor: 'Yes, you already own a monogrammed bathrobe. This one has BETTER initials. They are the same initials.' },
  { id: 'caviar_room_service',     name: 'Caviar Room Service',       tag: 'luxury', costBase: 5e8,   costGrowth: 1.9, comfort: 4200, exclusivity: 13, xMult: 0,xScope: 'all', unlockComfort: 1.8e8, flavor: 'Caviar at 2am, no eyebrow raised. You spread it on a stroopwafel. The waiter does not flinch. He has seen the passport.' },
  { id: 'personal_anthem',         name: 'A Personal Anthem',         tag: 'luxury', costBase: 8e8,   costGrowth: 1.9, comfort: 4500, exclusivity: 16, xMult: 0,xScope: 'all', unlockComfort: 2.2e8, flavor: 'The lobby plays a short fanfare when you enter. You pretend to be embarrassed. You have it played twice.' },
  { id: 'seven_star_concierge',    name: 'Seven-Star Concierge',      tag: 'luxury', costBase: 1.3e9, costGrowth: 1.9, comfort: 4800, exclusivity: 19, xMult: 0, xScope: 'all', unlockComfort: 2.6e8, flavor: 'A concierge for a rating that does not exist. He anticipates needs you have not had yet. It is unnerving, in a way you have started to enjoy.' },
  { id: 'rooftop_helipad_umbrella',name: 'Rooftop Helipad Umbrella',  tag: 'luxury', costBase: 2e9,   costGrowth: 1.9, comfort: 5100, exclusivity: 22, xMult: 0,xScope: 'all', unlockComfort: 3e8,   flavor: 'A parasol on the private helipad, against a sun you flew half your life to complain your way toward. The umbrella, at least, understands the irony.' },

  // --- Property-hosted amenities (E22 "A Bungalow of One's Own" — S5): micro-luxuries that attach
  // to an OWNED place. tag:'property' + `unlockProperty` gates them on owning the named deed (on
  // top of the Comfort gate), so the greedy harness — which never buys a deed — never sees them
  // and the island stays 29705s. They feed Comfort via the generic amenityScoreTotal (level 0 ⇒ 0,
  // bit-identical for the harness) and reuse the standard buyAmenity flow. costGrowth 1.5. ---
  { id: 'deck_hammock',      name: 'Deck Hammock',            tag: 'property', unlockProperty: 'bungalow', costBase: 6e9,  costGrowth: 1.5, comfort: 2.6e7, xMult: 0.03, xScope: 'all', unlockComfort: 1.5e8, flavor: 'A hammock. For when the sun, improbably, appears. It usually does now.' },
  { id: 'deck_mosquito',     name: 'Citronella Candle Set',   tag: 'property', unlockProperty: 'bungalow', costBase: 9e9,  costGrowth: 1.5, comfort: 2.9e7, xMult: 0.03, xScope: 'all', unlockComfort: 1.6e8, flavor: 'The mosquitoes were here first. You have decided this is negotiable.' },
  { id: 'deck_outdoor_shower', name: 'Outdoor Shower',        tag: 'property', unlockProperty: 'bungalow', costBase: 1.4e10,costGrowth: 1.5, comfort: 3.3e7, xMult: 0.035,xScope: 'all', unlockComfort: 1.8e8, flavor: 'You rinse off under open sky. Thirty years of one cold indoor trickle, and now this.' },
  { id: 'deck_sundowner',    name: 'Sundowner Cart',          tag: 'property', unlockProperty: 'bungalow', costBase: 2.1e10,costGrowth: 1.5, comfort: 3.7e7, xMult: 0.035,xScope: 'all', unlockComfort: 2.1e8, flavor: 'A little cart, wheeled out at sunset. It squeaks. You keep it that way, on purpose.' },
  { id: 'deck_firebowl',     name: 'Copper Fire Bowl',        tag: 'property', unlockProperty: 'bungalow', costBase: 3.2e10,costGrowth: 1.5, comfort: 4.1e7, xMult: 0.04, xScope: 'all', unlockComfort: 2.5e8, flavor: 'A bowl of fire on your own deck. Primal, expensive, extremely satisfying.' },
  { id: 'ow_glassrug',       name: 'Glass-Floor Rug',         tag: 'property', unlockProperty: 'overwater_villa', costBase: 8e10, costGrowth: 1.5, comfort: 6.0e7, xMult: 0.04, xScope: 'all', unlockComfort: 4e8,  flavor: 'A rug with a glass panel, over a floor with a glass panel, over the sea. Turtles included, at no extra charge.' },
  { id: 'ow_tideclock',      name: 'Brass Tide Clock',        tag: 'property', unlockProperty: 'overwater_villa', costBase: 1.2e11,costGrowth: 1.5, comfort: 6.6e7, xMult: 0.045,xScope: 'all', unlockComfort: 4.4e8, flavor: 'It tells the tide, not the time. You have stopped caring about the time. Progress.' },
  { id: 'ow_kayakrack',      name: 'Kayak Rack & Kayaks',     tag: 'property', unlockProperty: 'overwater_villa', costBase: 1.8e11,costGrowth: 1.5, comfort: 7.2e7, xMult: 0.045,xScope: 'all', unlockComfort: 5e8,  flavor: 'Two kayaks you will use twice, on a rack that cost more than your first three homes combined.' },
  { id: 'ow_snorkel_station',name: 'Snorkel Station',         tag: 'property', unlockProperty: 'overwater_villa', costBase: 2.7e11,costGrowth: 1.5, comfort: 7.9e7, xMult: 0.05, xScope: 'all', unlockComfort: 5.6e8, flavor: 'Masks, fins, a little bench. The reef is right there. You wave at it most mornings.' },
  { id: 'ow_seabed_lights',  name: 'Seabed Spotlights',       tag: 'property', unlockProperty: 'overwater_villa', costBase: 4e11,  costGrowth: 1.5, comfort: 8.6e7, xMult: 0.05, xScope: 'all', unlockComfort: 6.4e8, flavor: 'You light the sea floor at night, for the fish and for the pure absurd joy of it.' },

  // --- Grounds mega-clusters (E23 "Villa Vita" — S5): garden / pool complex / sport court. Ordinary
  // tag:'grounds' amenities with a `kind` (which cluster) + `unlockProperty` gate — so they appear
  // only once the villa/estate deed is owned. The greedy harness owns no property ⇒ never sees them
  // ⇒ island 29705s. They feed Comfort via the generic amenityScoreTotal (level 0 ⇒ 0, bit-identical
  // for the harness) and reuse buyAmenity. Estate staff (data/staff.js) can auto-buy a cluster's
  // cheapest node and light the property×staff synergy (L_estate). costGrowth 1.5. ---
  // garden (gardener)
  { id: 'grd_topiary',       name: 'Topiary Maze',            tag: 'grounds', kind: 'garden', unlockProperty: 'villa', costBase: 9e11,  costGrowth: 1.5, comfort: 1.0e8, xMult: 0.04, xScope: 'all', unlockComfort: 8e8,  flavor: 'A hedge maze. You got lost in it once, genuinely, for forty minutes. The gardener found you. Neither of you mentions it.' },
  { id: 'grd_rose_walk',     name: 'The Rose Walk',           tag: 'grounds', kind: 'garden', unlockProperty: 'villa', costBase: 1.4e12,costGrowth: 1.5, comfort: 1.1e8, xMult: 0.04, xScope: 'all', unlockComfort: 9e8,  flavor: 'A hundred metres of roses. You walk it at dusk, pretending it was always going to end this way.' },
  { id: 'grd_koi_pond',      name: 'Koi Pond',                tag: 'grounds', kind: 'garden', unlockProperty: 'villa', costBase: 2.1e12,costGrowth: 1.5, comfort: 1.3e8, xMult: 0.045,xScope: 'all', unlockComfort: 1.1e9, flavor: 'Fish worth more than your first car glide beneath the lilies. They are unimpressed by you, which feels correct.' },
  { id: 'grd_orangery',      name: 'Walled Orangery',         tag: 'grounds', kind: 'garden', unlockProperty: 'villa', costBase: 3.2e12,costGrowth: 1.5, comfort: 1.5e8, xMult: 0.045,xScope: 'all', unlockComfort: 1.4e9, flavor: 'Citrus, under glass, tended daily. You eat one orange a month. The rest is, apparently, "the look."' },
  { id: 'grd_fountain',      name: 'Tiered Stone Fountain',   tag: 'grounds', kind: 'garden', unlockProperty: 'villa', costBase: 4.8e12,costGrowth: 1.5, comfort: 1.7e8, xMult: 0.05, xScope: 'all', unlockComfort: 1.8e9, flavor: 'Water, pumped up only to fall down again, elegantly, forever. A perfect metaphor you choose not to examine.' },
  { id: 'grd_greenhouse',    name: 'Victorian Greenhouse',    tag: 'grounds', kind: 'garden', unlockProperty: 'villa', costBase: 7.2e12,costGrowth: 1.5, comfort: 1.9e8, xMult: 0.05, xScope: 'all', unlockComfort: 2.3e9, flavor: 'Wrought iron and old glass, warm and green in any weather. The one room where the Dutch rain would be welcome.' },
  // pool complex (pool technician)
  { id: 'grd_lap_pool',      name: 'Olympic Lap Pool',        tag: 'grounds', kind: 'pool',   unlockProperty: 'villa', costBase: 1.1e12,costGrowth: 1.5, comfort: 1.2e8, xMult: 0.045,xScope: 'all', unlockComfort: 9e8,  flavor: 'Fifty metres of your own water. You swim two lengths, majestically, then float. The floating is the real amenity.' },
  { id: 'grd_infinity',      name: 'Infinity Edge',           tag: 'grounds', kind: 'pool',   unlockProperty: 'villa', costBase: 1.7e12,costGrowth: 1.5, comfort: 1.4e8, xMult: 0.045,xScope: 'all', unlockComfort: 1.1e9, flavor: 'The water appears to end at the horizon. It does not. But the photograph says otherwise, and the photograph is what counts.' },
  { id: 'grd_swim_bar',      name: 'Swim-Up Bar',             tag: 'grounds', kind: 'pool',   unlockProperty: 'villa', costBase: 2.6e12,costGrowth: 1.5, comfort: 1.6e8, xMult: 0.05, xScope: 'all', unlockComfort: 1.4e9, flavor: 'A bar you swim to. The stools are underwater. It is deeply impractical and you love it without reservation.' },
  { id: 'grd_grotto',        name: 'Rock Grotto',             tag: 'grounds', kind: 'pool',   unlockProperty: 'villa', costBase: 4e12,  costGrowth: 1.5, comfort: 1.8e8, xMult: 0.05, xScope: 'all', unlockComfort: 1.8e9, flavor: 'A cave, behind the waterfall, with a hidden hot tub. Built at ruinous cost to look like it was always there.' },
  { id: 'grd_hot_springs',   name: 'Landscaped Hot Springs',  tag: 'grounds', kind: 'pool',   unlockProperty: 'villa', costBase: 6e12,  costGrowth: 1.5, comfort: 2.0e8, xMult: 0.055,xScope: 'all', unlockComfort: 2.3e9, flavor: 'Naturally heated water, "naturally" arranged by a landscaping firm from Rotterdam. The steam does not know the difference. Neither, most days, do you.' },
  // sport courts (groundskeeper) — gated on the ESTATE (tier 19)
  ...
  // owns no premium destination) ⇒ island 29705s. They feed Comfort via amenityScoreTotal. ---
  { id: 'sig_casino_suite',  name: 'Casino High-Roller Suite',   tag: 'signature', unlockDest: 'dest_monaco',     costBase: 5e9,   costGrowth: 1.6, comfort: 2.0e8, xMult: 0.06, xScope: 'all', unlockComfort: 0, flavor: 'A suite above the casino floor, comped. You gamble modestly, tip enormously, and leave up. The house, for once, does not mind.' },
  { id: 'sig_burj_floor',    name: 'A Floor of the Tower',       tag: 'signature', unlockDest: 'dest_dubai',      costBase: 1.4e10,costGrowth: 1.6, comfort: 2.6e8, xMult: 0.065,xScope: 'all', unlockComfort: 0, flavor: 'Not a room. A floor. The lifts have a button that is, specifically, yours. The desert is very far down.' },
  { id: 'sig_private_atoll', name: 'A Private Atoll',            tag: 'signature', unlockDest: 'dest_maldives',   costBase: 3.6e10,costGrowth: 1.6, comfort: 3.4e8, xMult: 0.07, xScope: 'all', unlockComfort: 0, flavor: 'Your own ring of sand and reef, staffed and provisioned, unreachable by anyone you did not invite. You invite almost no one.' },
  { id: 'sig_ski_chalet',    name: 'A Ski-In Chalet',            tag: 'signature', unlockDest: 'dest_aspen',      costBase: 9e10,  costGrowth: 1.6, comfort: 4.2e8, xMult: 0.075,xScope: 'all', unlockComfort: 0, flavor: 'Ski-in, ski-out, though you do neither. The fireplace is the size of your first flat. You mostly sit by it, warm, astonished.' },
  { id: 'sig_harbour_villa', name: 'A Harbour-Front Villa',      tag: 'signature', unlockDest: 'dest_st_barths',  costBase: 2.4e11,costGrowth: 1.6, comfort: 5.4e8, xMult: 0.08, xScope: 'all', unlockComfort: 0, flavor: 'The last address. A villa over a harbour of impossible boats, one of them yours. You watch the sunset the rich paid to hide. It was here all along.' },

  // --- Island starter cluster (E27 "The Island Listing" — S5): the first things you set up on your
  // own island. tag:'island' + unlockIsland (gated on OWNING the island — a gate the harness never
  // clears). "Setting up camp" — a dock, power, water, and the goat that came with the deed. They
  // feed Comfort via amenityScoreTotal. costGrowth 1.5. ---
  { id: 'isl_dock',        name: 'A Proper Dock',           tag: 'island', unlockIsland: true, costBase: 2e12,  costGrowth: 1.5, comfort: 6.0e8, xMult: 0.06, xScope: 'all', unlockComfort: 0, flavor: 'Somewhere to tie the boat that cost more than the island. Priorities, established.' },
  { id: 'isl_generator',   name: 'Island Generator',        tag: 'island', unlockIsland: true, costBase: 3.4e12,costGrowth: 1.5, comfort: 6.6e8, xMult: 0.06, xScope: 'all', unlockComfort: 0, flavor: 'Power, at last. The "no Wi-Fi yet" from the listing becomes "Wi-Fi, eventually." Progress.' },
  { id: 'isl_freshwater',  name: 'Freshwater Well',         tag: 'island', unlockIsland: true, costBase: 5.6e12,costGrowth: 1.5, comfort: 7.2e8, xMult: 0.065,xScope: 'all', unlockComfort: 0, flavor: 'Water that is yours, from ground that is yours. Thirty years of one cold indoor trickle led here.' },
